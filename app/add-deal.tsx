  ...
  const handleSave = async () => {
    ...
    try {
      const newDeal = {
        ...
        clientName: '',
        value: 0,
        dailyMargin: dailyMargin ? parseFloat(dailyMargin) : undefined,
        status,
        probability: 50,
      ...
      Alert.alert(
        'Successo',
        'Affare creato con successo!',
        [{ text: 'OK', onPress: () => router.back() }]
      );
    } catch (error) {
      console.error('Error creating deal:', error);
      Alert.alert('Errore', 'Errore durante la creazione dell\'affare');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Nuovo Affare</Text>
        ...
        >
          ...
          <Text style={styles.saveButtonText}>
            {isLoading ? 'Creazione...' : 'Crea Affare'}
          </Text>
        </TouchableOpacity>
      </ScrollView>
    </View>
