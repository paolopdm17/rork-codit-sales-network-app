...
export default function AddConsultantScreen() {
  ...
  const handleSave = async () => {
    ...
    setIsLoading(true);
    try {
      const consultantData: Omit<Consultant, 'id' | 'createdAt'> = {
      ...
      Alert.alert('Successo', 'Consulente aggiunto con successo', [
        { text: 'OK', onPress: () => router.back() }
      ]);
    } catch (error) {
      console.error('Error adding consultant:', error);
      Alert.alert('Errore', 'Errore durante l\'aggiunta del consulente');
    } finally {
      setIsLoading(false);
    }
  };
